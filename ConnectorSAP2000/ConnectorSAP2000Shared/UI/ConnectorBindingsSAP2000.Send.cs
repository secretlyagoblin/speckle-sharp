...
namespace Speckle.ConnectorSAP2000.UI
{
...

  {
    ...
    public override async Task SendStream(StreamState state, ProgressViewModel progress)
    {
      ...
      //var converter = new ConverterSAP2000();
      var converter = kit.LoadConverter(ConnectorSAP2000Utils.SAP2000AppName);
      ...
      //{
      //    commitObj["@Stories"] = converter.ConvertToSpeckle(("Stories", "SAP2000"));
      //}
      ...
      foreach (var applicationId in state.SelectedObjectIds)
      {
        ...
        var selectedObjectType = ConnectorSAP2000Utils.ObjectIDsTypesAndNames
        ...
        var typeAndName = ConnectorSAP2000Utils.ObjectIDsTypesAndNames
            .Where(pair => pair.Key == applicationId)
      ...
      Base ElementCount = converter.ConvertToSpeckle(("ElementsCount", "SAP2000"));
      ...
      {
        commitObj["@Model"] = converter.ConvertToSpeckle(("Model", "SAP2000"));
      }

      if (commitObj["AnalysisResults"] == null)
      {
        commitObj["AnalysisResults"] = converter.ConvertToSpeckle(("AnalysisResults", "SAP2000"));
      }
      ...
      var actualCommit = new CommitCreateInput
      {
        ...
        message = state.CommitMessage != null ? state.CommitMessage : $"Pushed {objCount} elements from SAP2000.",
        sourceApplication = ConnectorSAP2000Utils.SAP2000AppName
      };
